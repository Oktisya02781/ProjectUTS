...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>admin/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b>OKTISYA</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              foreach ($log as $key => $value) {
                ?>
              <img src="<?php echo base_url(); ?>gambar_petugas/tisya.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Oktisya Ruth D</span>
              <?php
              }
              ?>
            </a>
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ?>
                <img src="<?php echo base_url(); ?>gambar_petugas/tisya.jpg" class="img-circle" alt="User Image">

                <p>
                  Oktisya Ruth D
                  <small>Admin Perpus Oktisya</small>
                </p>
                <?php
              }
              ?>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>web/logout" class="btn btn-danger btn-flat">Log out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logo_sman3prabu.png" alt="" srcset="" width="47px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    <!-- To the right -->
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="www.smarak.net">OKTISYA</a>.</strong> All rights reserved.
  </footer>
